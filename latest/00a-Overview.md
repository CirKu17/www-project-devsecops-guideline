...
<img align="right" width="200" height="180" src="{{site.basePath}}/latest/assets/images/DevSecOps.png">
...
<img src="{{site.basePath}}/latest/assets/images/DevOps vs DevSecOps.png">
...
1. **Static testing**
   ...
   ![Static testing]({{site.basePath}}/latest//assets/images/sast_scanning.png)
...
2. **Dynamic testing**
   ...
   ![Dynamic testing]({{site.basePath}}/latest//assets/images/dast_scanning.png)
...
3. **Interactive analysis**
   ...
   ![Interactive analysis]({{site.basePath}}/latest//assets/images/iast_analysis.png)
